...
Ressources From : https://github.com/SohierDane/BigQuery_Helper/blob/master/bq_helper.py
...
class BigQueryHelper(object):
    ...
    """
		Author : DAB
		ADD Service Account Json Key
	"""
    def __init__(self, active_project, dataset_name, service_account_json_key):
        ...
        self.client = bigquery.Client.from_service_account_json(self.service_account_json_key)
        
        ## Get credentials from the service account JSON file
